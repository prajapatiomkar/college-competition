...
import { useCreateCompetitionMutation } from "../competition/competitionSilce.js";
import { useForm } from "react-hook-form";
import { useGetCollegeQuery } from "../college/collegeSlice.js";
  ...
  return (
    <form onSubmit={handleSubmit(onSubmitHandler)}>
      <button
        ...
        data-hs-overlay="#add-competition-modal"
      >
        Add Competition
      </button>
      <div
        id="add-competition-modal"
          ...
          <div className="flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
            ...
            <div className="p-4 overflow-y-auto">
              ...
              <input
                type="text"
                id="name"
                className="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 border"
